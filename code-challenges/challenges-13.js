...
const stringReverse = (str) => {
    ...
    return words.reduce((reversedStr, word) => {
...
const statistics = (obj) => {
    // write your code here
    return obj.reduce((statisticsObj, voter) => {
       
        if (voter.votes_To in statisticsObj) {
          
          statisticsObj[voter.votes_To]++;
        } else {
          
          statisticsObj[voter.votes_To] = 1;
        }
